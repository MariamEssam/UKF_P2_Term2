...
set "CarNDUKFProjectPlatform=x86"
...
rem set "VcPkgTriplet=%CarNDUKFProjectPlatform%-windows-%CarNDEKFProjectToolset%"
...
set "CarNDEKFProjectBuildDir=%~dp0\..\..\products\cmake.msbuild.windows.%CarNDUKFProjectPlatform%.%CarNDEKFProjectToolset%"
